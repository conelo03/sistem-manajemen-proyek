<!-- Navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= base_url('dashboard') ?>" class="brand-link">
      <img src="<?= base_url('assets') ?>/img/inti.PNG" alt="INTI Logo" class="brand-image img-square elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">INTI-MP</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?= base_url('assets/img/profile/'.$this->session->userdata('photos')) ?>" class="img-circle elevation-2" style="width: 33px; height: 33px;" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php if(is_pengelola()): ?>
            <li class="nav-item">
              <a href="<?= base_url('user') ?>" class="nav-link <?= $title == 'Users' ? 'active' : '' ?>">
          ...
          <?php endif; ?>
          <li class="nav-item">
            <a href="<?= base_url('project') ?>" class="nav-link <?= $title == 'Proyek' ? 'active' : '' ?>">
